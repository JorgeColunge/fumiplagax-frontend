...
const DocumentConfigurator = ({ selectedTemplateId, selectedEntity }) => {
  ...
  const getInspectionFields = (serviceType) => {
    const commonFields = [
      ...
      { label: "Categoría toxicológica", value: "findings_productsByType_toxicologicalCategory" },
      { label: "Especie a controlar", value: "findings_productsByType_targetSpecies" },
      { label: "Antidoto", value: "findings_productsByType_antidote" },
